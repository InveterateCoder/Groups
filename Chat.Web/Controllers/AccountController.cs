    ...
    public class AccountController : ControllerBase
    {
        ...
        private async Task<string> SendMail(string to, string name, string code)
        {
            ...
            try
            {
                ...
                msg.AddContent(MimeType.Html, mailContent);
                var client = new SendGridClient("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");
